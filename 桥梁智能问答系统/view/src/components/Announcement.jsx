  ...
  return (
    <div className="announcement">
      <div style={{ display: 'flex', alignItems: 'center' }}>
        ...
        <span>{isChinese ? '钢-混组合梁砼桥面板裂缝智能防治问答系统-V2 即将模型更新，新增对桥梁裂缝的检测识别。' : 'Sign-LM-V2 model updated. New gesture recognition accuracy increased by 30%. <br> Supports multi-country sign language conversion. Experience the new features now.'}</span>
      </div>
