    ...
    <div className="App">
      ...
      <section className="main-section">
        <div className="section-header">
          <h1>{isChinese ? '钢-混组合梁砼桥面板裂缝智能防治问答系统' : 'Sign-LM - Intelligent Sign Language Interaction System'}</h1>
          <p>{isChinese ? '基于rag检索增强技术的钢-混组合梁砼桥面板裂缝智能防治问答系统，为专业的桥梁人服务' : 'A sign language translation and Q&A system based on the Transformer architecture, supporting bidirectional conversion and real-time interaction.'}</p>
        </div>
